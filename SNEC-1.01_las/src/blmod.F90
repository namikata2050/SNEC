...
!quantities related to the heating by radioactive Ni
 ...
 !-------- Ouchi wrote this.---------
! quantities related to the heating by magnetar
 
 real*8, allocatable :: magnetar_heating(:)
 real*8, allocatable :: magnetar_total_luminosity
 ! ---------------------------------
...
!-------------------- evolution -------------------------------
  ...
  integer :: kout  ! the number of cells to inject the magnetar heat. 
  real*8 :: Lsd_ini  ! Initial spind-down luminosity (erg/s)
  real*8 :: tsd   ! Spin-down timescale (day)
  !  Magnetar heating: Lsd = Lsd_ini*(1d0 + time/t_sd_sec)**(-2)
! -------------------------
